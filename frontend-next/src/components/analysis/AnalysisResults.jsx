    ...
    <div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {typeof analysis.companyInfo?.industry === 'object' && 
             ...
             analysis.companyInfo.industry.secondary.length > 0 && (
              <div className="mt-1">
          ...
          <div>
            ...
            <p className="font-medium">
              ...
              {typeof analysis.companyInfo?.size === 'object' && 
               ...
               ` (Est. ${analysis.companyInfo.size.employeeEstimate} employees)`}
            </p>
          </div>
          <div>
        ...
        <div className="mt-3">
          ...
          <p className="text-sm">{analysis.companyInfo?.companyDescription || 
                                 analysis.companyInfo?.companyDesc || 
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              {analysis.businessFocus?.targetCustomers && analysis.businessFocus.targetCustomers.length > 0 ? (
                <ul className="list-disc pl-5 text-sm">
