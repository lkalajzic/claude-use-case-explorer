...
const Home = () => {
  return (
    <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
              <div className="relative bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div>
                  <div className="absolute -top-3 -left-3 flex items-center justify-center h-12 w-12 rounded-md bg-blue-600 text-white">
                ...
                <div className="mt-5">
                  <Link to="/analyzer" className="text-base font-medium text-blue-600 hover:text-blue-500">
                    Try the analyzer →
                  </Link>
                </div>
              </div>
              ...
              <div className="relative bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="mt-5">
                  <Link to="/use-cases" className="text-base font-medium text-blue-600 hover:text-blue-500">
                    Browse use cases →
                  </Link>
                </div>
              </div>
              ...
              <div className="relative bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="mt-5">
                  <Link to="/roi-calculator" className="text-base font-medium text-blue-600 hover:text-blue-500">
                    Calculate ROI →
                  </Link>
                </div>
              </div>
            ...
            <div className="space-y-10">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-1/2">
                  <div className="bg-blue-50 rounded-xl p-8 h-64 flex items-center justify-center">
      ...
      {/* CTA Section */}
      <div className="bg-blue-700 rounded-2xl my-12">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="block">Ready to explore Claude's potential?</span>
            <span className="block text-blue-200">Start your analysis today.</span>
          </h2>
